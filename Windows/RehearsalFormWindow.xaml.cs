...
namespace MusicCollective.Windows
{
    public partial class RehearsalFormWindow : Window
    {
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Выберите дату репетиции.");
                return;
            }
            ...
            {
                MessageBox.Show("Введите время начала репетиции.");
                return;
            }
            ...
            // Проверка ансамбля
            if (EnsembleCombo.SelectedValue == null)
            {
                MessageBox.Show("Выберите состав (ансамбль).");
                return;
            }
            ...
            using (var conn = new MySqlConnection(connectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@t", timeText);
